 ...
 */
@Service
public class SpringDataClientRegistrationServiceImpl implements ClientRegistrationService {
    ...
    @Transactional(readOnly = true)
    public Optional<SimpleClientDetails> findClient(String clientId) {
